...
sys.path.insert(0, r'..\..\ARES-pytorch-ares')
...
from rl_interaction.Reinforcement_Run import RLApplicationEnv
from selenium.common.exceptions import InvalidSessionIdException, WebDriverException
from rl_interaction.utils import Application_Details
...
def main():
    ...
    my_log = logger.add(os.path.join('Result', 'logger.log'), format="{time} {level} {message}",
    ...
    for application in apps:
        ...
        try:
            exported_activities, services, receivers, providers, string_activities, my_package = Application_Details.analyze(
                application,
                coverage_dict_template)
            ready = True
